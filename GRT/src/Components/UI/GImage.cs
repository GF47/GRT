...
namespace UnityEngine.UI
{
    ...
    /// </summary>
    public class GImage : MaskableGraphic, ISerializationCallbackReceiver, ILayoutElement, ICanvasRaycastFilter
    {
        /// <summary>
        ...
        [SerializeField] private Vector2 _slicedCenter = new Vector2(0.5f, 0.5f);
        ...
        private void GenerateSlicedSprite(VertexHelper toFill)
        {
            ...
            else
            {
                ...
                if (activeSprite != null)
                {
                    vector4_1 = Sprites.DataUtility.GetOuterUV(this.activeSprite);
                    vector4_2 = Sprites.DataUtility.GetInnerUV(this.activeSprite);
                    vector4_3 = Sprites.DataUtility.GetPadding(this.activeSprite);
                ...
                float leftWidth = outWidth * _slicedCenter.x;
                ...
                float topHeight = outHeight * _slicedCenter.y;
        ...
        private static List<GImage> m_TrackedTexturelessImages = new List<GImage>();
        ...
        private static void TrackImage(GImage g)
        {
            if (!s_Initialized)
            {
        ...
        private static void UnTrackImage(GImage g)
        {
